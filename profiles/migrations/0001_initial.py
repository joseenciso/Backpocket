    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_phone_number', models.CharField(blank=True, max_length=80)),
                ('default_country', django_countries.fields.CountryField(blank=True, max_length=2)),
                ('default_postcode', models.CharField(blank=True, max_length=80)),
                ('default_town_or_city', models.CharField(blank=True, max_length=80)),
